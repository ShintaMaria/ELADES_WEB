...
@section('content')
    ...
    <!-- STRUKTUR -->
    <section id="struktur" class="about section text-center pt-5">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-12" data-aos="fade-up" data-aos-delay="300">
                    <div class="image-wrapper">
                        <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                            <img src="{{ asset('landingpage/assets/img/strukturr.png') }}" alt="Struktur Organisasi" class="img-fluid w-100 rounded-4">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- VISI & MISI -->
    <section id="visimisi" class="features section">
        <!-- Section Title -->
    ...
    <!-- APLIKASI -->
    <section id="aplikasi" class="testimonials section light-background">
        <section id="features-2" class="features-2 section">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <!-- ARTIKEL -->
                <section id="artikel" class="services section light-background">
                    <!-- Section Title -->
                    <div class="container section-title" data-aos="fade-up">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-5" data-aos="fade-up">
                                ...
                                <p class="faq-description">Temukan jawaban atas pertanyaan yang sering diajukan mengenai layanan dan program desa.</p>
                            ...
                            <div class="col-lg-7" data-aos="fade-up" data-aos-delay="300">
                                <div class="faq-container">
                                    ...
                                    <div class="faq-item">
                                        ...
                                        <div class="faq-content">
                                            <p>Kelurahan Kauman memiliki program unggulan untuk meningkatkan kualitas hidup warganya. Salah satunya adalah Sinau Bareng, yang fokus pada peningkatan literasi dan numerasi anak-anak di RT 01 RW 04, melibatkan relawan, orang tua, dan tokoh masyarakat. Selain itu, program Keluarga Berencana (KB) dijalankan melalui subprogram BKB untuk tumbuh kembang balita, BKR untuk pembinaan remaja, dan BKL bagi lansia. Program UPPKA juga mendorong keluarga akseptor KB menjalankan usaha produktif guna meningkatkan ekonomi keluarga</p>
                                        </div>
                                        <i class="faq-toggle bi bi-chevron-right"></i>
                                    </div><!-- End Faq item-->
                                    ...
                                    <div class="faq-item">
                                        ...
                                        <div class="faq-content">
                                            <p> Informasi dan pengumuman terbaru dari Desa Kauman dapat diakses melalui fitur Kabar Desa di aplikasi mobile resmi desa.</p>
                                        </div>
                                        <i class="faq-toggle bi bi-chevron-right"></i>
                                    </div><!-- End Faq item-->
                                </div>
                ...
                <!-- MAPS -->
                <section id="maps" class="maps section light-background">
                    <!-- Section Title -->
                    <div class="container section-title" data-aos="fade-up">
